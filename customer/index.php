...
<body>
                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li>
                                    <a href="logout.php"><span class="flaticon-arrow"></span></a>
                                </li>
    ...
    <main>
        <!-- ? New Product Start -->
        <section class="new-product-area section-padding10">
            <div class="container">
                <!-- Section tittle -->
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-8 col-md-7">
                        <div class="footer-copy-right">
                            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">mwx</a>
 </p>
                        </div>
                    </div>
